...
| [0004](keps/0004-discoverable-deviations.md) | Discoverable Deviations from R7RS-small | Accepted (amended 2026-08-28: Phase 2 shipped; naming and ship-gate questions resolved) | `kaappi` core, `kaappi.github.io` |
...
| [0022](keps/0022-subprocess-support.md) | Native Subprocess Support — `(kaappi process)` | Draft | `kaappi` core |
